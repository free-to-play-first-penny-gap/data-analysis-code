...
random_device1 <- lm(data_3$"device_tierAndroid.tier.1" ~ data_3$test_bucket, data=data_3)
summary(random_device1)

random_device2 <- lm(data_3$"device_tierAndroid.tier.2" ~ data_3$test_bucket, data=data_3)
summary(random_device2)

random_device3 <- lm(data_3$"device_tierAndroid.tier.3" ~ data_3$test_bucket, data=data_3)
summary(random_device3)

random_device4 <- lm(data_3$"device_tierAndroid.tier.4" ~ data_3$test_bucket, data=data_3)
summary(random_device4)

random_device5 <- lm(data_3$"device_tierAndroid.tier.5" ~ data_3$test_bucket, data=data_3)
summary(random_device5)

random_country1 <- lm(data_3$"country_tierCountry.tier.1" ~ data_3$test_bucket, data=data_3)
summary(random_country1)

random_country2 <- lm(data_3$"country_tierCountry.tier.2" ~ data_3$test_bucket, data=data_3)
summary(random_country2)

random_country3 <- lm(data_3$"country_tierCountry.tier.3" ~ data_3$test_bucket, data=data_3)
summary(random_country3)

random_country4 <- lm(data_3$"country_tierCountry.tier.4" ~ data_3$test_bucket, data=data_3)
summary(random_country4)
